        ...
        <div className="flex align-middle">
          <span>
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clip-path="url(#clip0_5330_241)">
                <g filter="url(#filter0_d_5330_241)">
                  <path
                ...
                <g filter="url(#filter1_d_5330_241)">
                  <path
                ...
                <g filter="url(#filter2_d_5330_241)">
                  <path
                ...
                <g filter="url(#filter3_d_5330_241)">
                  <path
                ...
                <path
                  d="M18.986 7V10.1939M30 18.1255H24.493H20.986C19.8814 18.1255 18.986 17.23 18.986 16.1255V10.1939M18.986 10.1939H16M18.986 10.1939H25.6014C26.706 10.1939 27.6014 11.0893 27.6014 12.1939V21"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    mode="normal"
                    in2="BackgroundImageFix"
                    result="effect1_dropShadow_5330_241"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
                    in2="effect1_dropShadow_5330_241"
                    result="shape"
                  />
                </filter>
                <filter
                  id="filter1_d_5330_241"
                  x="82.9922"
                  y="6"
                  width="20.3594"
                  height="22.75"

...
const Appsumo = (props: any) => {
  ...
  const submitApi = async (e: { preventDefault: () => void }) => {
    ...
    if (code !== 'null' && code.length === 19) {
      ...
      /*axios.post('api/verify', { email: email, phrase: code }).then((res) => {
        ...
        if (os === 'macos') {
          window.open(
            'https://github.com/achuthhadnoor/www/releases/download/0.0.1/capshot-0.0.10.dmg',
            '_blank'
          )
          setLoading(false)
          return
          ...
          window.open(
            'https://github.com/achuthhadnoor/www/releases/download/0.0.1/capshot-0.0.10-arm64.dmg',
            '_blank'
          )
          setLoading(false)
          return
  ...
  return (
    <Container
      title={'capshot | Appsumo '}
      description="Download capshot for macOs and windows"
    >
      <section className=" mx-auto mt-24 max-w-4xl">
        ...
        <div className="my-5 mx-auto mt-2">
          ...
          <p className="my-5 max-w-xl leading-loose">
            ...
            capshot and enjoy creating amaizing time-capshot videos
        ...
        <div className="my-5 mx-auto rounded-md bg-gray-900 px-4 py-5 shadow-md">
          <h3 className="mt-2 text-lg">
            Start recoding your amaizing digital work in time-capshot
          </h3>
          <form
